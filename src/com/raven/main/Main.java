    ...
    public Main() {
        ...
        try{
            ...
            Calendar kalender = Calendar.getInstance();
                String sql = "SELECT SUM(jumlah) as j, month(tanggal) as t from transaksi WHERE year(tanggal) = '"+ FormatTahun.format(kalender.getTime()) +"' GROUP BY month(tanggal)";
        ...
        chart.addLegend("Penjualan", new Color(99, 231, 252));
        try{
            int i=0;
            Connection c = Koneksi1.getKoneksi();
            DateFormat FormatTahun = new SimpleDateFormat("yyyy");
            Calendar kalender = Calendar.getInstance();
                String sql = "SELECT SUM(jumlah) as j, month(tanggal) as t from tb_supplier WHERE year(tanggal) = '"+ FormatTahun.format(kalender.getTime()) +"' GROUP BY month(tanggal)";
                Statement s = c.createStatement();
                ResultSet r = s.executeQuery(sql);
                while(r.next()){
