...
public class laporanBarangKeluar extends javax.swing.JDialog {
    ...
    public void dataTable(){
        Object[] Baris = {"No","ID Transaksi","Kode Barang","Tanggal Transaksi","Jumlah","Jumlah Bayar","Kembalian","Harga"};
    ...
    public void pencarian(String sql){
        ...
        try{
            ...
            while (hasil.next()){
                ...
                String jumlah_byr = hasil.getString("jumlah_byr");
                String kembalian = hasil.getString("kembalian");
                String total_harga = hasil.getString("total_harga");
                String[] data = {"",id_transaksi,kode_barang,tgl_transaksi,jumlah,jumlah_byr,kembalian,total_harga};
                tabmode.addRow(data);
                noTable();
            }
        } catch(Exception e){
    ...
    private void txtCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyTyped
        String sqlPencarian = "select * from transaksi where id_transaksi like '%"+txtCari.getText()+"%' or kode_barang like '%"+txtCari.getText()+"%'";
    ...
    private void btnTampilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTampilActionPerformed
        ...
        String sql = "select * from transaksi where tgl_transaksi between '"+tanggalAwal+"' and '"+tanggalAkhir+"'";
        try{
            java.sql.Statement stat = conn.createStatement();
            ResultSet hasil = stat.executeQuery(sql);
            while (hasil.next()){
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        try {
            ...
            File file = new File("src/laporan/reportBarangKeluar.jrxml");
            String tampilan = "dd-MM-yyyy";
            SimpleDateFormat fm = new SimpleDateFormat(tampilan);
            String tanggalAwal = String.valueOf(fm.format(tglAwal.getDate()));
            String tanggalAkhir = String.valueOf(fm.format(tglAkhir.getDate()));
