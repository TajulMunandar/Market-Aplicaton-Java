...
public class laporanBarangMasuk extends javax.swing.JDialog {
    ...
    public void dataTable(){
        Object[] Baris = {"No","ID Beli","ID Barang","Suplier","Tanggal Pembelian","Harga Satuan","Jumlah Barang","Total Harga"};
    ...
    public void pencarian(String sql){
        ...
        try{
            ...
            while (hasil.next()){
                String id_beli = hasil.getString("id_beli");
                String id_barang = hasil.getString("id_barang");
                String suplier = hasil.getString("suplier");
                String tgl_beli = hasil.getString("tgl_beli");
                ...
                String[] data = {"",id_beli,id_barang,suplier,tgl_beli,harga_satuan,jumlah_barang,total_harga};
                tabmode.addRow(data);
                noTable();
            }
        } catch(Exception e){
    ...
    private void txtCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyTyped
        String sqlPencarian = "select * from pembelianbrg where id_beli like '%"+txtCari.getText()+"%' or suplier like '%"+txtCari.getText()+"%'";
    ...
    private void btnTampilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTampilActionPerformed
        ...
        String sql = "select * from pembelianbrg where tgl_beli between '"+tanggalAwal+"' and '"+tanggalAkhir+"'";
        try{
            java.sql.Statement stat = conn.createStatement();
            ResultSet hasil = stat.executeQuery(sql);
            while (hasil.next()){
