...
public class laporanGaji extends javax.swing.JDialog {
    ...
    public void dataTable(){
        Object[] Baris = {"No","ID Karyawan","Nama Karyawan","ID Kategori","Stok","Harga Jual","Harga Beli"};
        ...
        try{
            ...
            while (hasil.next()){
                ...
                String[] data = {"",id_karyawan,nama_karyawan,id_ktgr,stok,harga_jual,harga_beli};
                tabmode.addRow(data);
                noTable();
                lebarKolom();
            }
     ...
     */
    public laporanGaji(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tanggal();
        dataTable();
    ...
    private void initComponents() {
        ...
        labelNama.setText("Laporan Gaji Karyawan");
    ...
    private void txtCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyTyped
        String sqlPencarian = "select * from karyawan where id_karyawan like '%"+txtCari.getText()+"%' or nama_karyawan like '%"+txtCari.getText()+"%'";
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        try {
            ...
            File file = new File("src/laporan/reportGajiKaryawan.jrxml");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            laporanGaji dialog = new laporanGaji(new javax.swing.JFrame(), true);
