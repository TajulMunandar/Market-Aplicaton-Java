...
public class laporanStokBarang extends javax.swing.JDialog {
    ...
    public void dataTable(){
        Object[] Baris = {"No","Kode Barang","Nama Barang","ID Kategori","Stok","Harga Jual","Harga Beli"};
        ...
        try{
            ...
            while (hasil.next()){
                ...
                String[] data = {"",kode_barang,nama_barang,id_ktgr,stok,harga_jual,harga_beli};
                tabmode.addRow(data);
                noTable();
                lebarKolom();
            }
    ...
    private void initComponents() {
        ...
        btnCetak1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        btnCetak1.setText("Cetak Laporan Perhari");
        btnCetak1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
